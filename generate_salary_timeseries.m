...
t_settlement = datetime(2024,04,01);
...
gsr_salary_old_student_prequal(t_apr23_raise<=t & t<t_settlement) = 0.4*step6_fte(t_apr23_raise<=t & t<t_settlement);
gsr_salary_old_student_prequal(t_settlement<=t) = 0.5*step6_fte(t_settlement<=t);
...
gsr_salary_old_student_postqual(t_apr23_raise<=t & t<t_settlement) = 0.43*step6_fte(t_apr23_raise<=t&t<t_settlement);
gsr_salary_old_student_postqual(t_settlement<=t) = 0.5*step6_fte(t_settlement<=t);
